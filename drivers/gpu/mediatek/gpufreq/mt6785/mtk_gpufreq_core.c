...
static struct g_opp_table_info g_opp_table_segment[] = {
	...
	GPUOP(SEG_GPU_DVFS_FREQ32, SEG_GPU_DVFS_VOLT32, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ33, SEG_GPU_DVFS_VOLT33, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ34, SEG_GPU_DVFS_VOLT34, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ35, SEG_GPU_DVFS_VOLT35, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ36, SEG_GPU_DVFS_VOLT36, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ37, SEG_GPU_DVFS_VOLT37, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ38, SEG_GPU_DVFS_VOLT38, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ39, SEG_GPU_DVFS_VOLT39, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ40, SEG_GPU_DVFS_VOLT40, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ41, SEG_GPU_DVFS_VOLT41, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ42, SEG_GPU_DVFS_VOLT42, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ43, SEG_GPU_DVFS_VOLT43, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ44, SEG_GPU_DVFS_VOLT44, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ45, SEG_GPU_DVFS_VOLT45, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ46, SEG_GPU_DVFS_VOLT46, SEG_GPU_DVFS_VSRAM29),
	GPUOP(SEG_GPU_DVFS_FREQ47, SEG_GPU_DVFS_VOLT47, SEG_GPU_DVFS_VSRAM29),
};
