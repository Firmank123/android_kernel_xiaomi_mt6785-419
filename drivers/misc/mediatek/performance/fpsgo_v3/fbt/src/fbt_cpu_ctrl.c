...
#define FREQ_QOS_MAX PM_QOS_MAX
#define FREQ_QOS_MIN PM_QOS_MIN
#define freq_qos_add_request(_constraints, _req, _type, _value) (0)
#define freq_qos_add_notifier(_constraints, _type, _notifier) (0)
#define freq_qos_update_request(_req, _value) (0)
#endif
